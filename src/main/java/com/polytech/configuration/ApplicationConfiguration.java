package com.polytech.configuration;
...
@EnableJpaRepositories(basePackages = {"com.polytech.repository", "com.polytech.account.repository"})
public class ApplicationConfiguration {
	...
	*/
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource,
		...
		emfb.setPackagesToScan("com.polytech.models", "com.polytech.account.models");
		return emfb;
	}
